...
The Armory Deployments Plugin provides a single stage solution for deploying an application using a Canary Deployment Strategy to your Kubernetes clusters. For example, you can configure a new deployment to serve 10% of the traffic initially and then increment from there. The deployment can only progress if the criteria you set are met, either a wait time or manually approval. These criteria give you a chance to evaluate the state of the deployment to make sure things are working as intended.
...
| HTTPS                       | api.cloud.armory.io                      | 443  | Spinnaker         | **Armory Cloud REST API**<br><br>Used to fetch information from the Kubernetes cache.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| HTTPS                       | [github.com](http://github.com)                                        | 443  | Spinnaker         | **Github**<br><br>Used to download official Armory plugins when Armory Enterprise starts up time.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
