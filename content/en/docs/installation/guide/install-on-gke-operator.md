...
>If you want to install Spinnaker<sup>TM</sup>, use the open source Operator, which you download its GitHub [repo](https://github.com/armory/spinnaker-operator).
