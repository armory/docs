...
no_list: true
description: >
  The Armory Operator is a Kubernetes Operator that makes it easy to install, deploy, and upgrade any version of Spinnaker or the Armory Enterprise Platform for Spinnaker. This section covers Armory Operator advantages, configuration, deployment, and migration from Halyard to the Armory Operator.
aliases:
