...
| `input.pipeline.stages[].completeOtherBranchesThenFail`           | `boolean`  | should the pipeline finish other branches, and then fail if this stage fails.                                                                                                                                            |
| `input.pipeline.stages[].continuePipeline`                        | `boolean`  | should the pipeline continue if this stage fails.                                                                                                                                            |
| `input.pipeline.stages[].failPipeline`                            | `boolean`  | should the pipeline fail if this stage fails                                                                                                                                            |
