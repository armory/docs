...
| `input.pipeline.stages[].context.kato.tasks[].resultObjects[].boundArtifacts[]`                                                                  | `[array]` | See [artifacts]({{< ref "artifacts.md" >}}) for more information. |
| `input.pipeline.stages[].context.kato.tasks[].resultObjects[].createdArtifacts[]`                                                                | `[array]` | See [artifacts]({{< ref "artifacts.md" >}}) for more information. |
...
| `input.pipeline.stages[].context.optionalArtifacts[]`                                                                                            | `[array]` | See [artifacts]({{< ref "artifacts.md" >}}) for more information. |
| `input.pipeline.stages[].context.outputs.boundArtifacts[]`                                                                                       | `[array]` | See [artifacts]({{< ref "artifacts.md" >}}) for more information. |
| `input.pipeline.stages[].context.outputs.createdArtifacts[]`                                                                                     | `[array]` | See [artifacts]({{< ref "artifacts.md" >}}) for more information. |
...
| `input.pipeline.stages[].outputs.optionalArtifacts[]`                                                                                            | `[array]` | See [artifacts]({{< ref "artifacts.md" >}}) for more information. |
| `input.pipeline.stages[].outputs.outputs.boundArtifacts[]`                                                                                       | `[array]` | See [artifacts]({{< ref "artifacts.md" >}}) for more information. |
| `input.pipeline.stages[].outputs.outputs.createdArtifacts[]`                                                                                     | `[array]` | See [artifacts]({{< ref "artifacts.md" >}}) for more information. |
