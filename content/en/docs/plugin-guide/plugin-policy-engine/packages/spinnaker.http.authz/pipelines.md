...
| `input.body.stages[].baseAmi`                                        | `string`  | Only available for the `bake` stage.<br/> If Base AMI is specified, this will be used instead of the Base OS provided.                                                                                                                                   |
...
| `input.body.stages[].skipExpressionEvaluation`                       | `boolean` | If true then SpEL will not be evaluated in artifacts referenced by the stage.                                                                                                                                                                            |
