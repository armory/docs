...
- [Armory Spinnaker Operator]({{< ref "operator" >}}) helps you configure, deploy, and update Spinnaker on Kubernetes clusters. The proprietary Armory Spinnaker Operator has extended functionality not available in the Open Source Spinnaker Operator. 
