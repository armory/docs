...
{{< alert title="Note" >}}This document is intended for users who have purchased the Armory AWS Container Marketplace offering.{{< /alert >}}

## Overview

{{< alert title="Note" >}}This is a placeholder document and will be updated once the Armory Spinnaker AWS Container Marketplace offering has been published.{{< /alert >}}
