...
{{% alert title=Note %}}Vault Enterprise Namespaces is a Vault Enterprise feature. Want to see support for more Vault Enterprise? Let us know at <https://feedback.armory.io>. {{% /alert %}}
