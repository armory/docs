...
{{% alert title="New feature" %}}Named Profiles is a new feature in Armory Spinnaker 2.20. Previously, you needed to mount a sidecar. If you are on an earlier version, see this [page](https://archive.docs.armory.io/docs/spinnaker/terraform-enable-integration/#configure-terraform-for-your-cloud-provider) for an earlier version of Armory Spinnaker to learn more about mounting a sidecar. {{% /alert %}}
