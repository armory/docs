...
There is a known issue that relates to the "Application Attributes" section under the Config menu. An application that was already created and configured in Spinnaker will display the message “This application has not been configured.” While the information is missing, there is no functional impact.
