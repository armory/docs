...
This release fixes the [canary validator issue]({{< ref "armory-operator-v1-4-1#known-issues" >}}) that caused the Armory Enterprise deployment to fail when  `metadataCachingIntervalMS` was in the canary configuration.
