---
title: v2.36.8 Armory Continuous Deployment Release (Spinnaker™ v1.36.1)
toc_hide: true
version: 2.36.8
date: 2026-03-05
description: >
  Release notes for Armory Continuous Deployment v2.36.8.
---
...
Upstream references:
- [Spinnaker v1.36.1](https://www.spinnaker.io/changelogs/1.36.1-changelog/)
- [Spinnaker v1.36.2](https://www.spinnaker.io/changelogs/1.36.2-changelog/)
- [Spinnaker v1.36.3](https://www.spinnaker.io/changelogs/1.36.3-changelog/)
...
- fix(validation): URL validation hardening on underscore/authority handling (upstream [#7428](https://github.com/spinnaker/spinnaker/pull/7428))
- fix(cats-sql): make `SqlUnknownAgentCleanupAgent` sharding-aware (upstream [#7431](https://github.com/spinnaker/spinnaker/pull/7431))
- refactor(sharding): pluggable sharding strategy for caching pods (upstream [#7432](https://github.com/spinnaker/spinnaker/pull/7432))
- feat(scheduler): add Redis priority scheduler (upstream [#7433](https://github.com/spinnaker/spinnaker/pull/7433))
...
- fix(validation): URL restriction parsing/validation alignment for webhook restrictions (upstream [#7428](https://github.com/spinnaker/spinnaker/pull/7428))
