---
title: v2.36.9 Armory Continuous Deployment Release (Spinnaker™ v1.36.1)
toc_hide: true
version: 2.36.9
date: 2026-04-01
description: >
  Release notes for Armory Continuous Deployment v2.36.9.
---
...
- Clouddriver (GitRepo artifacts): validation fixes around user input and repository URL handling (backports [#7542](https://github.com/spinnaker/spinnaker/pull/7542), [#7564](https://github.com/spinnaker/spinnaker/pull/7564)).
...
- fix(validation): Fixes some validation around user inputs (upstream [#7542](https://github.com/spinnaker/spinnaker/pull/7542))
- fix(gitrepo): Fix git repo with some odd character combinations (upstream [#7564](https://github.com/spinnaker/spinnaker/pull/7564))
