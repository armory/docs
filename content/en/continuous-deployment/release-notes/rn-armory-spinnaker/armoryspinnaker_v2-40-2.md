---
title: v2.40.2 Armory Continuous Deployment Release (Spinnaker™ 2026.2.2)
toc_hide: true
version: 2.40.2
date: 2026-07-27
description: >
  Release notes for Armory Continuous Deployment v2.40.2.
---
...
To install, upgrade, or configure Armory CD 2.40.2, use Armory Operator 1.8.6 or later.
...
Armory CD 2.40.2 upgrades to Spring Boot 3.5, the latest supported release. This is a major upgrade from Spring Boot 3.0 introduced in Armory CD 2.39.0. Plugins built against earlier Spring Boot versions will need to be updated to be compatible with this release.
...
Due to recent SQL library upgrades, MySQL 5.7 is no longer supported and will fail on startup. You must be running MySQL 8.0+ or an equivalent MariaDB version before upgrading to Armory CD 2.40.2.

### Redis/Valkey 7+ now required

Redis or Valkey 7.0+ is required for Armory CD 2.40.2. Older versions are not supported and may cause failures. Armory already deploys Redis 7+ by default — verify your Redis version before upgrading if you manage your own Redis instance.
...
services:
  clouddriver:
    commit: 6e605c0756d2286bed4b85326b084af6e8ab8c20
    version: 2.40.2
  deck:
    commit: 6e605c0756d2286bed4b85326b084af6e8ab8c20
    version: 2.40.2
...
#### Armory Igor - 2.40.2...2.40.2


#### Armory Fiat - 2.40.2...2.40.2


#### Armory Orca - 2.40.2...2.40.2


#### Armory Rosco - 2.40.2...2.40.2


#### Armory Front50 - 2.40.2...2.40.2


#### Armory Echo - 2.40.2...2.40.2


#### Armory Clouddriver - 2.40.2...2.40.2


#### Armory Gate - 2.40.2...2.40.2


#### Armory Dinghy - 2.40.2...2.40.2


#### Armory Deck - 2.40.2...2.40.2


#### Armory Kayenta - 2.40.2...2.40.2


#### Armory Terraformer - 2.40.2...2.40.2
