---
title: v2.40.6 Armory Continuous Deployment Release (Spinnaker™ 2026.2.3)
toc_hide: true
version: 2.40.6
date: 2026-09-10
description: >
  Release notes for Armory Continuous Deployment v2.40.6.
---
...
To install, upgrade, or configure Armory CD 2.40.6, use Armory Operator 1.8.6 or later.
...
### SpeL support of dash(-) in variable names
SpEL by default tokenizes - as the arithmetic minus operator, not a valid identifier character.
Enabling the following configuration in orca-local.yml now adds support to treat the - as a valid identifier character
during SpeL variable evaluation.
...
[Spinnaker 2026.2.3](https://www.spinnaker.io/changelogs/2026.2.3-changelog/) changelog for details.
...
services:
  clouddriver:
    commit: b38a6833fa13146aa92462c39589d4e8bec150bf
    version: 2.40.6
  deck:
    commit: b38a6833fa13146aa92462c39589d4e8bec150bf
    version: 2.40.6
...
#### Armory Deck - 2.40.5...2.40.6


#### Armory Rosco - 2.40.5...2.40.6


#### Armory Terraformer - 2.40.5...2.40.6


#### Armory Kayenta - 2.40.5...2.40.6


#### Armory Orca - 2.40.5...2.40.6


#### Armory Gate - 2.40.5...2.40.6


#### Armory Igor - 2.40.5...2.40.6


#### Armory Fiat - 2.40.5...2.40.6


#### Armory Front50 - 2.40.5...2.40.6


#### Armory Dinghy - 2.40.5...2.40.6


#### Armory Echo - 2.40.5...2.40.6


#### Armory Clouddriver - 2.40.5...2.40.6
