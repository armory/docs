...
For information about how to configure the backing store for Pipelines as Code, see [Configuring SQL]({{< ref "plugins/pipelines-as-code/enable-cdsh#configuring-redis" >}}).
