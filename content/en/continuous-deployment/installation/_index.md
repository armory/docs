...
|-----------------------------------------------------------|------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|
| [Spinnaker Operator Quickstart]({{< ref "install-spinnaker" >}}) | Kubernetes, Spinnaker Operator, Kustomize     | Install the Spinnaker Operator and use it with the `spinnaker-kustomize-patches` repo to deploy Spinnaker to your Kubernetes cluster. |
