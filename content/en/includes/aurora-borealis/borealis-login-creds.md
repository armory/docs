The login credentials you use when you run the Borealis CLI locally and need to authenticate yourself to Armory's hosted services, such as when you run the `login` command with the Borealis CLI. 
